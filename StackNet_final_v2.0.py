...
del train_test['distance_manhatten_loc']
del train_test['distance_brooklyn_loc']
del train_test['distance_bronx_loc']
del train_test['distance_queens_loc']
del train_test['distance_staten_loc']


features_to_use.remove('distance_manhatten_loc')
features_to_use.remove('distance_brooklyn_loc')
features_to_use.remove('distance_bronx_loc')
features_to_use.remove('distance_queens_loc')
features_to_use.remove('distance_staten_loc')
#################################################################################################
